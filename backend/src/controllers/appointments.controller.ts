...
export const updateAppointment = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (data.startTime || data.endTime) {
            ...
            const professionalId = data.professionalId || existingAppointment.professionalId;
...
export const checkAppointmentAvailability = async (req: AuthRequest, res: Response) => {
    try {
        const dbUser = req.dbUser;
