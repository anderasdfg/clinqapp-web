...
interface ServicesState {
    ...
    // Actions
    fetchServices: (params?: { page?: number; limit?: number; search?: string; isActive?: boolean }) => Promise<void>;
...
export const useServicesStore = create<ServicesState>((set) => ({
    ...
    createService: async (data) => {
        ...
        try {
            ...
            await state.fetchServices({ page: state.pagination.page, limit: state.pagination.limit });
        } catch (error) {
            set({
