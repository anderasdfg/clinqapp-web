...
export const appointmentsService = {
     ...
     */
    async getAppointments(params?: AppointmentsQueryParams): Promise<AppointmentsListResponse> {
    ...
    async checkAvailability(params: AvailabilityCheckParams): Promise<boolean> {
        const response = await api.get<AvailabilityResponse>('/appointments/availability', { params });
