...
import type { ServiceListResponse, ServiceResponse, ServiceFormData } from '@/types/service.types';
...
export const servicesService = {
    ...
    // Update service
    async updateService(id: string, data: Partial<ServiceFormData>): Promise<ServiceResponse> {
