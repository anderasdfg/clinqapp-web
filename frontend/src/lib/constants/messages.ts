export const AuthMessages = {
  ...
  VERIFICATION_EMAIL_RESENT: "Correo de verificación reenviado exitosamente.",
  VERIFICATION_EMAIL_ERROR: "Error al reenviar el correo de verificación.",
  PASSWORD_RESET_SENT:
    "Se ha enviado un correo con instrucciones para restablecer tu contraseña.",
  PASSWORD_RESET_ERROR: "Error al enviar el correo de recuperación.",
} as const;
...
export const ValidationMessages = {
  ...
  DOCUMENT_TYPE_REQUIRED: "Selecciona un tipo de documento",
  DNI_REQUIRED: "El DNI es requerido",
  DNI_INVALID: "El DNI debe tener exactamente 8 dígitos numéricos",
  CE_INVALID:
    "El Carnet de Extranjería debe tener exactamente 9 dígitos numéricos",
  RUC_INVALID: "El RUC debe tener 11 dígitos y comenzar con 10, 20 o 15",
