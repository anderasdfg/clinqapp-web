...
const registerSchema = z.object({
    ...
    dni: z.string()
        .length(8, ValidationMessages.DNI_INVALID)
        .regex(/^\d+$/, ValidationMessages.DNI_INVALID),
    email: z.string()
                    ...
                    <div className="animate-fade-in w-full">
                        ...
                        <div className="space-y-4 mb-12">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-white/90 font-light">Configuración en menos de 5 minutos</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span className="text-white/90 font-light">30 días de prueba gratuita</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span className="text-white/90 font-light">Soporte técnico incluido</span>
                            </div>
                        </div>
                ...
                <div className="w-full max-w-md animate-slide-up">
                        ...
                        <div className="pt-2">
                            <label className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-[rgb(var(--text-secondary))] font-light">
                                    ...
                                    {' '}y la{' '}
                                    <Link to="/privacy" className="text-secondary hover:text-secondary-hover font-medium">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid gap-3">
                            <button
                                type="button"
                                className="flex items-center justify-center gap-2 px-4 py-3 border border-[rgb(var(--border-primary))] rounded-xl hover:bg-[rgb(var(--bg-secondary))] transition-all duration-200 font-medium text-sm"
                            >
