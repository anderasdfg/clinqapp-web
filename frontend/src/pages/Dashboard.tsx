...
const Dashboard = () => {
    return (
        <div className="min-h-screen bg-[rgb(var(--bg-secondary))]">
            {/* Header */}
            <header className="bg-[rgb(var(--bg-card))] border-b border-[rgb(var(--border-primary))] sticky top-0 z-50 shadow-sm">
                    ...
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-4">
                            ...
                            <nav className="hidden md:flex gap-6">
                                <a href="#" className="text-[rgb(var(--text-primary))] hover:text-primary transition-colors duration-200 font-medium">
                                    Inicio
                                </a>
                                <a href="#" className="text-[rgb(var(--text-secondary))] hover:text-primary transition-colors duration-200">
                                    Pacientes
                                </a>
                                <a href="#" className="text-[rgb(var(--text-secondary))] hover:text-primary transition-colors duration-200">
                                    Agenda
                        ...
                        <div className="flex items-center gap-4">
                            <ThemeToggle />
                            <button className="p-2 rounded-lg hover:bg-[rgb(var(--bg-secondary))] transition-colors duration-200">
